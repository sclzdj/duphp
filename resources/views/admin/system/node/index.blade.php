            ...
            <div class="block">
                ...
                <div class="block-content tab-content">
                    <div class="alert alert-warning alert-dismissable">
                        <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
                        <p><strong><i class="fa fa-fw fa-info-circle"></i> 提示：</strong>按住表头可拖动节点，调整后点击【保存节点】；启用节点会连它的所有长辈节点一起启用；禁用节点会连它的所有后代节点一起禁用</p>
                    </div>
                        ...
                        <div class="row data-table-toolbar">
                            <div class="col-sm-12">
                                <div class="toolbar-btn-action">
                                    ...
                                    <button title="保存" type="button" class="btn btn-default disabled" href="{{action('Admin\System\NodeController@sort')}}" submit-type="POST" id="save" disabled=""><i class="fa fa-check-circle-o"></i> 保存节点</button>
